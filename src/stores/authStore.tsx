...
// import { provider, signer } from '../initialisers/ethers.tsx';
...
//     try {
//       // Get nonce
//       const res = await axios.get('http://localhost:3000/nonce');
...
//       // Send to server
//       const res2 = await axios.post('http://localhost:3000/verify', { message, signature });
